...
def test_add_rec():
    ...
    res = client.post(
        ...
        json={
            "debate_id": debateID,
            "user_id": aliceID,
            "audio_content": "the first sentence.",
        },
    ...
    res5 = client.post(
        ...
        json={
            "debate_id": debateID,
            "user_id": bobID,
            "audio_content": "the second sentence.",
        },
        headers={"Authorization": "Bearer " + tokenAdmin},
    )
    ...
    res6 = client.post(
        ...
        json={
            "debate_id": debateID,
            "user_id": aliceID,
            "audio_content": "the third sentence.",
        },
        headers={"Authorization": "Bearer " + tokenAdmin},
    )
    ...
    res7 = client.post(
        ...
        json={
            "debate_id": debateID2,
            "user_id": bobID,
            "audio_content": "the unrelated sentence.",
        },
        headers={"Authorization": "Bearer " + tokenAdmin},
    )
...
def test_link_rec():
    ...
    assert (
        res4.json().get("detail")
        == "Next and Current Recordings Have Different Debate ID"
    )
...
def test_del_rec():
    res = client.delete(
        f"/recording/{recID3}", headers={"Authorization": "Bearer " + tokenAdmin}
    )
    assert res.status_code == 200
